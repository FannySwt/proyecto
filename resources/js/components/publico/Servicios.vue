        ...
        <div class="font-weight-light title mb-2">
          ...
          <v-layout>
            ...
            <div class="text-xs-center">
              <v-layout>
                <v-btn @click="actualizarServicio" color="info">Ver</v-btn>
              </v-layout>
            </div>
          </v-layout>
        </div>
    ...
    <v-dialog v-model="dialog" width="500">
      <v-card class="mx-auto" color="grey lighten-4" max-width="600">
        ...
        <v-layout>
          <div class="h4 font-weight-light blue--text mb-2">
            <v-flex xs12 justify-start>Ver información del usuario
              <v-btn slot="activador" @click="verPerfil(servicio.user_id)" fab small color="info">
                <v-icon>search</v-icon>
              </v-btn>
            </v-flex>
          </div>
        ...
        <v-card width="100%">
          ...
          <v-list three-line subheader>
            ...
            <v-list-tile avatar>
              ...
              <v-data-table :headers="headers" :items="serviciosUsuario" hide-actions>
